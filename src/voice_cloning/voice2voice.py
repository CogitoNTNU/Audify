...
def voice2voice(
    ...
    """
    #
    model_downloader.make_sure_models_are_downloaded(install_path=MODELS_DIR)
    # Load the HuBERT model
    hubert_manager, hubert_model, model, tokenizer = model_downloader.get_hubert_manager_and_model()
